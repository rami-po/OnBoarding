export const LETTER = 'Hello <mark>FIRST_NAME</mark> <mark>LAST_NAME</mark>,' +
  '<br /><br />' +
  'Welcome to the productOps team! We\'re so excited to have you join at 9:00am on <mark>START_DATE</mark>.' +
  '<br /><br />' +
  ...
  '<li>I-9 Form (complete online and print)</li>' +
  ...
  '<li>Dental Application (optional; complete and print)*</li></ul><br />' +
  ...
  '<li>Review medical insurance premium costs</li></ul></li></ol><br />' +
